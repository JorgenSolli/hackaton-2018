<div class="ui fluid search selection dropdown cities-airports-dropdown">
    ...
    <div class="menu">
        {{-- Surprise me has satatic data for demo purposes --}}
        <div class="item" data-value="THA"><i class="location arrow icon"></i>Surprise me!</div>
        <div class="item"><i class="globe icon"></i>Africa</div>
        <div class="item"><i class="globe icon"></i>Americas</div>
        <div class="item"><i class="globe icon"></i>Asia</div>
        <div class="item"><i class="globe icon"></i>Europe</div>
        <div class="item"><i class="globe icon"></i>Oceania</div>
        ...
        <div class="item" data-value="JPN"><i class="jp flag"></i>Japan</div>
        ...
        <div class="item" data-value="NOR"><i class="no flag"></i>Norway</div>
